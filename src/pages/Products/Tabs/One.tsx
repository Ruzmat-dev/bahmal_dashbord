...
import { Button, Modal, Pill, Select, Slider, TextInput, Textarea, Title } from '@mantine/core'
...
const schema = yup.object({
  ...
  length: yup.string().required().min(2).max(100),
  density: yup.string().required().min(2).max(100),
  weaving: yup.string().required().min(2).max(100),
  ...
  yarn_number: yup.string().min(2).max(100),
